...
public class ManHinh extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnMenu.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 230, 130));
        ...
        pnMenu.add(pntrangchu, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 230, 50));
        ...
        pnMenu.add(pnHoaDon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 230, 50));
        ...
        pnMenu.add(pnNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 230, 50));
        ...
        pnMenu.add(pnKhachHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 230, 50));

        pnThongKe.setBackground(new java.awt.Color(51, 51, 51));

        lblThongKe.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblThongKe.setForeground(new java.awt.Color(255, 255, 255));
        lblThongKe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/currencies.png"))); // NOI18N
        ...
        pnMenu.add(pnThongKe, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 230, 50));
        ...
        pnMenu.add(pnDangXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 230, 50));
        ...
        pnMenu.add(pnSanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 230, 50));
        ...
        pnMenu.add(pnBanHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 230, 50));

        pnManHinh.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        pnManHinh.setPreferredSize(new java.awt.Dimension(1600, 0));
        pnManHinh.setLayout(new java.awt.BorderLayout());
        ...
        pnRootLayout.setHorizontalGroup(
            ...
            .addGroup(pnRootLayout.createSequentialGroup()
                ...
                .addComponent(pnManHinh, javax.swing.GroupLayout.DEFAULT_SIZE, 750, Short.MAX_VALUE))
        );
        pnRootLayout.setVerticalGroup(
            pnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnManHinh, javax.swing.GroupLayout.DEFAULT_SIZE, 785, Short.MAX_VALUE)
            .addComponent(pnMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 785, Short.MAX_VALUE)
        );
